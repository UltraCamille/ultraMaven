...
public class Ultra_accountManagement_Wallet {
...
public void UpData1gb()  throws InterruptedException, IOException {
		cloverLogIn();
		  Thread.sleep(1000);
		  wait.until(ExpectedConditions.elementToBeClickable(cd.dugtrio_textbox_input())).sendKeys("6572478637"); 
		  Thread.sleep(1000);
		  ...
		  wait.until(ExpectedConditions.visibilityOfElementLocated(cd.dugtrio_textbox_wallet_amount())).sendKeys("30.00");
		  Thread.sleep(1000);
